// src/components/CreatePlanDialog.tsx
...
const CreatePlanDialog: React.FC<Props> = ({ open, onClose, onCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    setError(null);
    try {
      await api.post<ApiResponse<SubscriptionPlan>>('/api/v1/super-admin/plans', formData);
      onCreated();
      onClose();
    } catch (err: unknown) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      ...
      <DialogContent>
        {/* ✅ MUI Grid v2: use size={{ xs, sm }} instead of item xs sm */}
